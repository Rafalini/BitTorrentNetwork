...
//    }
    ...
    BOOST_AUTO_TEST_CASE(multiple_keys_config) {
        ...
        auto expected = Config::Data{
                {"192.168.20.11", {{"file1", "192.168.20.11"}, {"file2", "192.168.20.11"}, {"file3", "192.168.20.11"}}},
                {"192.168.20.12", {{"file1", "192.168.20.11"}}},
                {"192.168.20.13", {{"file1", "192.168.20.11"}, {"file2", "192.168.20.11"}, {"file3", "192.168.20.11"}, {"file4", "192.168.20.11"}}},
                {"192.168.20.14", {{"file1", "192.168.20.11"}, {"file2", "192.168.20.11"}}}
        };
        BOOST_TEST(cfg == expected);
    }
